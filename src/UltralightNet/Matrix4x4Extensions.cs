...
public static partial class Methods
{
	...
	public static partial Matrix4x4 ulApplyProjection(Matrix4x4 transform, float viewport_width, float viewport_height, [MarshalAs(UnmanagedType.U1)] bool flip_y);
}
