...
public static unsafe partial class Methods
{
	...
	public static partial IntPtr ulCreateKeyEvent(
		...
		[MarshalAs(UnmanagedType.U1)] bool is_keypad,
		[MarshalAs(UnmanagedType.U1)] bool is_auto_repeat,
		[MarshalAs(UnmanagedType.U1)] bool is_system_key);
	...
	public static IntPtr ulCreateKeyEventWindows(ULKeyEventType type, UIntPtr wparam, IntPtr lparam)
	{
		...
		try
		{
			return ((delegate* unmanaged[Cdecl]<ULKeyEventType, UIntPtr, IntPtr, IntPtr>)NativeLibrary.GetExport(ul, "ulCreateKeyEventWindows"))(type, wparam, lparam);
		}
		finally
		{
	...
	public static IntPtr ulCreateKeyEventMacOS(IntPtr nsevent)
	{
		...
		try
		{
			return ((delegate* unmanaged[Cdecl]<IntPtr, IntPtr>)NativeLibrary.GetExport(ul, "ulCreateKeyEventMacOS"))(nsevent);
		}
		finally
		{
			NativeLibrary.Free(ul);
