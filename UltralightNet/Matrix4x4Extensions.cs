...
namespace UltralightNet
{
	public static partial class Methods
	{
		...
		public static extern Matrix4x4 ulApplyProjection(Matrix4x4 transform, float viewport_width, float viewport_height, [MarshalAs(UnmanagedType.I1)] bool flip_y);
	}
